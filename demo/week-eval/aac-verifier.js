(() => {
  ...
  // ../../../agent-action-capsule/ts/node_modules/cborg/lib/is.js
  function is(value) {
    if (value === null) {
      return "null";
    }
  ...
  // ../../../agent-action-capsule/ts/node_modules/cborg/lib/token.js
  var Type, Token;
  ...
  // ../../../agent-action-capsule/ts/node_modules/cborg/lib/byte-utils.js
  ...
  // ../../../agent-action-capsule/ts/node_modules/cborg/lib/bl.js
  ...
  // ../../../agent-action-capsule/ts/node_modules/cborg/lib/common.js
  ...
  // ../../../agent-action-capsule/ts/node_modules/cborg/lib/0uint.js
  ...
  // ../../../agent-action-capsule/ts/node_modules/cborg/lib/1negint.js
  ...
  // ../../../agent-action-capsule/ts/node_modules/cborg/lib/2bytes.js
  ...
  // ../../../agent-action-capsule/ts/node_modules/cborg/lib/3string.js
  ...
  // ../../../agent-action-capsule/ts/node_modules/cborg/lib/4array.js
  ...
  // ../../../agent-action-capsule/ts/node_modules/cborg/lib/5map.js
  ...
  // ../../../agent-action-capsule/ts/node_modules/cborg/lib/6tag.js
  ...
  // ../../../agent-action-capsule/ts/node_modules/cborg/lib/7float.js
  ...
  // ../../../agent-action-capsule/ts/node_modules/cborg/lib/jump.js
  ...
  // ../../../agent-action-capsule/ts/node_modules/cborg/lib/encode.js
  ...
  // ../../../agent-action-capsule/ts/node_modules/cborg/lib/decode.js
  ...
  // ../../../agent-action-capsule/ts/node_modules/cborg/lib/tagged.js
  var Tagged;
  ...
  // ../../../agent-action-capsule/ts/node_modules/cborg/cborg.js
  ...
  // ../../../agent-action-capsule/ts/dist/json.js
  ...
  function render(value, path2, seen, depth) {
    ...
    if (seen.has(value))
      throw new TypeError(`cyclic JSON value at ${path2}`);
    seen.add(value);
    try {
      if (Array.isArray(value)) {
        for (let i = 0; i < value.length; i += 1)
          if (!(i in value))
            throw new TypeError(`sparse array at ${path2}[${i}]`);
  ...
  // ../../../agent-action-capsule/ts/dist/disclosure-path.js
  ...
  // ../../../agent-action-capsule/ts/dist/registries.js
  ...
  // ../../../agent-action-capsule/ts/dist/references.js
    ...
    for (const [i, raw] of capsule.references.entries()) {
      ...
      for (const field of ["type", "digest_alg", "digest"]) {
        if (typeof ref[field] !== "string" || ref[field] === "") {
          add("reference_malformed", `${path2}.${field} MUST be a non-empty string (\xA75.5.5)`, 1);
        }
      }
      if (ref.type === "agent-action-capsule" && ref.digest_alg === "SHA-256") {
        if (typeof ref.digest === "string" && ref.digest !== "" && !isHex64(ref.digest)) {
          add("reference_malformed", `${path2}.digest MUST be an AAC Capsule ID for agent-action-capsule/SHA-256 (\xA75.5.5)`, 1);
        }
        if (typeof parent2 === "string" && parent2 !== "" && ref.digest === parent2) {
          add("reference_duplicates_chain_parent", `${path2} duplicates chain.parent_capsule_id (\xA75.5.5)`, 6);
        }
      }
      if ("citation_purpose" in ref) {
        if (typeof ref.citation_purpose !== "string" || ref.citation_purpose === "") {
          add("reference_malformed", `${path2}.citation_purpose MUST be a non-empty string (\xA75.5.5)`, 1);
        } else if (!purposes.has(ref.citation_purpose)) {
          add("unknown_registry_value", `${path2}.citation_purpose is not seeded; informational, not rejected (\xA712)`, 8, "info");
        }
      }
      if ("log_coordinates" in ref) {
        const coordinates = asJsonObject(ref.log_coordinates);
        if (coordinates === void 0) {
          add("reference_log_coordinates_malformed", `${path2}.log_coordinates MUST be an object (\xA75.5.5)`, 1);
          continue;
        }
        for (const field of ["log_id", "leaf_index", "inclusion_proof"]) {
          if (!(field in coordinates) || coordinates[field] === null) {
            add("reference_log_coordinates_malformed", `${path2}.log_coordinates requires ${field} (\xA75.5.5)`, 1);
          }
        }
      }
    }
  ...
  // ../../../agent-action-capsule/ts/dist/data/cpb_provisional.json
  ...
  // ../../../agent-action-capsule/ts/dist/provisional.js
  ...
  // ../../../agent-action-capsule/ts/dist/verify.js
  ...
  function pathFind(value, predicate, path2 = "") {
    ...
    if (Array.isArray(value))
      return value.flatMap((child, index) => pathFind(child, predicate, `${path2}[${index}]`));
    const record = object(value);
    if (record === void 0)
      return [];
    return Object.keys(record).sort().flatMap((key) => pathFind(record[key], predicate, path2 === "" ? key : `${path2}.${key}`));
  }
  var v4IrreversibilityClasses = registries.irreversibility_class;
  async function verifyClass1(capsule, store, extensions2 = {}) {
    const findings = [];
    const add = (code, detail, check, severity = "error") => {
      findings.push(check === void 0 ? { code, detail, severity } : { code, detail, severity, check });
    };
    ...
    const references = referenceFindings(top, /* @__PURE__ */ new Set([
    ...
    if (typeof top.capsule_id === "string" && carriedId === void 0)
      add("capsule_id_malformed", "capsule_id MUST be 64 lowercase hex (\xA75.1)", 1);
    if (typeof top.action_type === "string" && top.action_type !== "fyi" && top.action_type !== "decide")
      add("action_type_invalid", "action_type MUST be 'fyi' or 'decide' (\xA75.1)", 1);
    if (typeof top.format_version === "string") {
      if (top.format_version === "4" && top.canonicalization_id !== "jcs")
        add(!("canonicalization_id" in top) ? "canonicalization_id_missing" : typeof top.canonicalization_id === "string" ? "canonicalization_profile_mismatch" : "canonicalization_id_not_string", 'format_version "4" REQUIRES canonicalization_id="jcs" (\xA75.1)', 1);
      else if (top.format_version !== "4")
        add("unsupported_format_version", `format_version ${JSON.stringify(top.format_version)} is not supported; expected "4" (\xA75.1)`, 1);
    }
    for (const field of [
      "effect",
      "assurance",
    ...
    if ("constraints" in top && !Array.isArray(top.constraints))
      add("constraints_not_array", "constraints MUST be an array when present (\xA78.1)", 1);
    for (const path2 of pathFind(top, (n) => /[.eE]/u.test(n.raw)))
      add("float_in_digest_field", `floating-point value at ${path2}; \xA75.1 forbids it`, 1);
    for (const path2 of pathFind(top, (n) => !/[.eE]/u.test(n.raw) && (BigInt(n.raw) > 9007199254740991n || BigInt(n.raw) < -9007199254740991n)))
      add("unsafe_integer_in_digest_field", `integer outside the JS-safe range (+/-9007199254740991) at ${path2}`, 1);
    const disposition = object(top.disposition);
    if (disposition !== void 0) {
      if (typeof disposition.approver !== "string")
        add("missing_required_field", "disposition.approver is REQUIRED (\xA75.4)", 1);
      else if (!["human", "policy", "counterparty"].includes(disposition.approver))
        add("approver_invalid", "disposition.approver has an invalid value (\xA75.4)", 1);
      if (!("decision" in disposition))
        add("missing_required_field", "disposition.decision is REQUIRED (\xA75.4)", 1);
      if (typeof disposition.human_disposed !== "boolean")
        add("field_not_bool", "disposition.human_disposed MUST be boolean (\xA75.4)", 1);
      if (disposition.human_disposed === true && disposition.approver !== "human")
        add("dishonest_human_disposed", "human_disposed=true with non-human approver (\xA75.4)", void 0, "warning");
    }
    ...
    if (status === "confirmed" && !(typeof effect?.response_digest === "string" && isHex64(effect.response_digest)))
      add("confirmed_without_response", "effect.status 'confirmed' requires 64-hex response_digest (\xA75.2)", 3);
    const effectMode = effect === void 0 || status === "planned" ? "not_applicable" : status === "confirmed" && typeof effect.response_digest === "string" && isHex64(effect.response_digest) ? "confirmed" : "dispatched_unconfirmed";
    ...
    if ((/* @__PURE__ */ new Set([
      ...
      add("verdict_effect_conflict", `verdict_class ${JSON.stringify(verdict)} requires effect_mode "not_applicable" (\xA75.4.2)`, 4);
    if (effectMode === "not_applicable" && effect?.effect_attestation !== void 0 && effect.effect_attestation !== null)
      add("effect_attestation_present", "effect_attestation MUST be absent for effect_mode 'not_applicable' (\xA75.2)", 5);
    if (effect !== void 0 && status !== "planned" && (effect.effect_attestation === void 0 || effect.effect_attestation === null))
      add("effect_attestation_missing", "dispatched effect requires effect_attestation (\xA75.2)", 5);
    const chain = object(top.chain);
    if (chain !== void 0) {
      if (!(typeof chain.parent_capsule_id === "string" && isHex64(chain.parent_capsule_id)))
        add("chain_parent_malformed", "chain.parent_capsule_id MUST be 64-hex capsule_id (\xA75.4.4)", 6);
      if (!("relation" in chain))
        add("missing_required_field", "chain.relation is REQUIRED when chain block is present (\xA75.4.4)", 6);
      if (store === void 0)
        add("chain_check_store_level", "chain parent-existence and concurrent-supersedes are store-level checks (\xA76); not run without store", 6, "info");
      else {
        ...
        if (typeof chain.parent_capsule_id === "string" && !ids.has(chain.parent_capsule_id))
          add("chain_parent_missing", `chain parent ${chain.parent_capsule_id} not found in store (\xA76)`, 6);
      }
    }
    ...
    if (typeof stated?.effect_mode === "string" && (rank[stated.effect_mode] ?? -1) > rank[effectMode])
      add("assurance_overclaim", `claimed effect_mode ${JSON.stringify(stated.effect_mode)} but verifier derived ${JSON.stringify(effectMode)} (\xA75.3)`, 7);
    ...
    if (typeof stated?.attestation_mode === "string" && (attestationRank[stated.attestation_mode] ?? -1) > attestationRank.self_attested)
      add("assurance_overclaim", `claimed attestation_mode ${JSON.stringify(stated.attestation_mode)} but verifier derived "self_attested" (\xA75.3)`, 7, "info");
    const ledgerRank = {
      standalone: 0,
      chained: 1,
      anchored: 2
    ...
    if (typeof stated?.ledger_mode === "string" && (ledgerRank[stated.ledger_mode] ?? -1) > ledgerRank[ledgerMode])
      add("assurance_overclaim", `claimed ledger_mode ${JSON.stringify(stated.ledger_mode)} but verifier derived ${JSON.stringify(ledgerMode)} (\xA75.3)`, 7, "info");
    const crossRank = {
    ...
    if (typeof stated?.cross_party_rung === "string" && (crossRank[stated.cross_party_rung] ?? -1) > crossRank[crossPartyRung ?? "unilateral_fallback"])
      add("assurance_overclaim", `claimed cross_party_rung ${JSON.stringify(stated.cross_party_rung)} but verifier derived ${JSON.stringify(crossPartyRung ?? "unilateral_fallback")} (\xA75.3 Cross-party assurance)`, 7, "info");
    const fields = [
    ...
    for (const [registry, block, member] of fields) {
      ...
      if (typeof value === "string" && !accepted.has(value)) {
        ...
        if (provisional !== void 0) {
          add("known_provisional_registry_value", `${member}=${JSON.stringify(value)} resolves known status 'provisional' via vendored CPB registry (payload class ${JSON.stringify(provisional)}); informational, not rejected (\xA712)`, 8, "info");
          continue;
        }
        add("unknown_registry_value", `${member}=${JSON.stringify(value)} is not a seeded ${registry} value; informational, not rejected (\xA712)`, 8, "info");
        if (registry === "effect_attestation")
          add("effect_attestation_graded_floor", "unknown effect_attestation is graded no stronger than 'runtime_claimed' (\xA75.2)", 8, "info");
      }
    }
  ...
  // ../../../agent-action-capsule/ts/dist/disclosure-envelope.js
  ...
  // ../../../agent-action-capsule/ts/dist/bundle.js
  init_browser();
  ...
  // ../../../agent-action-capsule/ts/dist/producer-envelope-verification.js
  init_cborg();

  // ../../../agent-action-capsule/ts/dist/producer-envelope-wire.js
  ...
  // browser_entry.mjs
  globalThis.AAC = { verifyBundle, decodeFragment };
})();
